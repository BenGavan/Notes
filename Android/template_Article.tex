...
\lstdefinelanguage{JavaScript}{
	keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, public, class, static, private, void, int, boolean, final, abstract, for, super, this, extends, implements},
